 ...
 *         <p>
 *         When the user selects a file, the button changes its style so the she could realize that she has to push the
 *         button.
 *         </p>
 */
public class FixedSingleUploader extends FixedUploader {
     ...
     */
    @UiConstructor
    public FixedSingleUploader(FileInputType type) {
        this(type, null);
    }
     ...
     */
    public FixedSingleUploader(FileInputType type, IUploadStatus status) {
     ...
     */
    public FixedSingleUploader(FileInputType type, IUploadStatus status, Widget submitButton) {
     ...
     *            Customized status widget to use
     */
    public FixedSingleUploader(IUploadStatus status) {
     ...
     *            Customized button which submits the form
     */
    public FixedSingleUploader(IUploadStatus status, Widget submitButton) {
    ...
    public void resetUploadedInfo() {
        this.serverInfo = new UploadedInfo();
    }

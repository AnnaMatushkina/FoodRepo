...
public class CommonResources_Bundle_gecko1_8_ru_InlineClientBundleGenerator implements com.google.gwt.resources.client.CommonResources.Bundle {
  private static CommonResources_Bundle_gecko1_8_ru_InlineClientBundleGenerator _instance0 = new CommonResources_Bundle_gecko1_8_ru_InlineClientBundleGenerator();
  private void inlineBlockStyleInitializer() {
    inlineBlockStyle = new com.google.gwt.resources.client.CommonResources.InlineBlockStyle() {
      ...
      public String getText() {
        return (".GPG4JGXCLD{display:" + ("\\-moz-inline-box")  + ";position:" + ("relative")  + ";display:" + ("inline-block")  + ";}");
      }

...
public class CustomScrollPanel_Resources_ru_InlineClientBundleGenerator implements com.google.gwt.user.client.ui.CustomScrollPanel.Resources {
  private static CustomScrollPanel_Resources_ru_InlineClientBundleGenerator _instance0 = new CustomScrollPanel_Resources_ru_InlineClientBundleGenerator();
  private void customScrollPanelStyleInitializer() {
    customScrollPanelStyle = new com.google.gwt.user.client.ui.CustomScrollPanel.Style() {
      ...
      public String getText() {
        return (".GPG4JGXCBL{background:" + ("#efefef")  + ";}");
      }

...
public class NativeHorizontalScrollbar_ResourcesTransparant_ru_StaticClientBundleGenerator implements com.google.gwt.user.client.ui.NativeHorizontalScrollbar.ResourcesTransparant {
  private static NativeHorizontalScrollbar_ResourcesTransparant_ru_StaticClientBundleGenerator _instance0 = new NativeHorizontalScrollbar_ResourcesTransparant_ru_StaticClientBundleGenerator();
  private void nativeHorizontalScrollbarStyleInitializer() {
    nativeHorizontalScrollbarStyle = new com.google.gwt.user.client.ui.NativeHorizontalScrollbar.Style() {
      ...
      public String getText() {
        return (".GPG4JGXCCL{opacity:" + ("0.7")  + ";filter:" + ("alpha(opacity = 70)")  + ";-webkit-transition:" + ("opacity"+ " " +"350ms")  + ";-moz-transition:" + ("opacity"+ " " +"350ms")  + ";-o-transition:" + ("opacity"+ " " +"350ms")  + ";transition:" + ("opacity"+ " " +"350ms")  + ";}.GPG4JGXCCL:hover{opacity:" + ("1")  + ";filter:" + ("alpha(opacity = 100)")  + ";}");
      }

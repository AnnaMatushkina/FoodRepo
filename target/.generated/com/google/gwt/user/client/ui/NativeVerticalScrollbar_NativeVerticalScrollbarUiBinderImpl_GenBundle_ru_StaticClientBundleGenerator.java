...
public class NativeVerticalScrollbar_NativeVerticalScrollbarUiBinderImpl_GenBundle_ru_StaticClientBundleGenerator implements com.google.gwt.user.client.ui.NativeVerticalScrollbar_NativeVerticalScrollbarUiBinderImpl_GenBundle {
  private static NativeVerticalScrollbar_NativeVerticalScrollbarUiBinderImpl_GenBundle_ru_StaticClientBundleGenerator _instance0 = new NativeVerticalScrollbar_NativeVerticalScrollbarUiBinderImpl_GenBundle_ru_StaticClientBundleGenerator();
  private void styleInitializer() {
    style = new com.google.gwt.user.client.ui.NativeVerticalScrollbar_NativeVerticalScrollbarUiBinderImpl_GenCss_style() {
      ...
      public String getText() {
        return (".GPG4JGXCML{position:" + ("relative")  + ";overflow:" + ("hidden")  + ";direction:" + ("ltr")  + ";}.GPG4JGXCLL{position:" + ("absolute")  + ";top:" + ("0")  + ";right:" + ("0")  + ";height:" + ("100%")  + ";width:" + ("100px")  + ";overflow-y:" + ("scroll")  + ";overflow-x:" + ("hidden")  + ";}");
      }
